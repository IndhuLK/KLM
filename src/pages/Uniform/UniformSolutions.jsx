...
const UniformSolutions = () => {
  return (
    <section className="py-16 px-6 md:px-12 lg:px-20 bg-white">
      ...
      {/* TOP SMALL TITLE */}
      <h3 
        className="text-center text-sm font-semibold text-[#2563eb] tracking-widest uppercase mb-3"
        data-aos="fade-down"
      >
      ...
      {/* MAIN HEADING */}
      <h2 
        className="text-center text-2xl md:text-4xl font-extrabold text-black font-poppins mb-12 max-w-2xl mx-auto"
        data-aos="fade-down"
        data-aos-delay="150"
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-20 md:gap-20 place-items-center">
        ...
        {/* LEFT CARD */}
        <div 
          className="relative bg-[#F7CDBA] p-8 pt-16 w-full max-w-sm text-center border border-gray-200"
          data-aos="fade-up"
          data-aos-delay="100"
        >
          <img 
        ...
        {/* CENTER CARD */}
        <div 
          className="relative bg-[#073597] p-8 pt-30 w-full max-w-sm text-center border border-gray-200 text-white"
          data-aos="fade-up"
          data-aos-delay="250"
        >
          <img 
