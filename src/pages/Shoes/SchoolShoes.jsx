...
const SchoolShoes = () => {
  ...
  const LIGHT_BG = "linear-gradient(135deg, #fff8f2 0%, #ffe6cc 100%)";
  ...
  return (
    <section className="relative overflow-hidden ">
      ...
      {/* Decorative Orbs */}
      <div className="absolute -top-24 -left-16 w-80 h-80 bg-[#EC3338]/10 blur-3xl
       rounded-full"></div>
      <div className="absolute bottom-0 right-0 w-[28rem] h-[28rem] bg-[#000000]/10 blur-3xl
       rounded-full"></div>

      {/* --- Heading Section --- */}
      <div className="px-6 md:px-16 pt-14 md:pt-20 text-left" data-aos="fade-right">
        <h2 className="text-2xl md:text-5xl font-extrabold leading-tight font-poppins text-[#000]">
          <span style={{ color: BRAND_RED }}>School Shoes</span> — Trusted Quality, <br />
          <span className="text-[#000000]">Bulk Distribution</span>
        </h2>
        <div
      ...
      <div
        className="relative mt-2 md:mt-2 px-6 md:px-16 py-10 md:py-5 rounded-3xl 
                   shadow-[0_10px_50px_rgba(0,0,0,0.05)] bg-white/70 backdrop-blur-sm"
        data-aos="fade-up"
      >
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="md:w-1/2 space-y-4" data-aos="fade-right">
            ...
            >
              KLM — Authorized Distributor for  Premium School Shoes
            </h3>
            ...
            {/* Feature Points */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 pt-1 md:pt-1">
              {[
                ...
                >
                  ...
                  <div
                    className="absolute bottom-0 left-0 h-[2px] w-0 bg-[#EC3338]
            ...
            <button
              className="relative mt-10 inline-flex items-center gap-3 px-6 py-3 rounded-full 
                         font-semibold text-white bg-[#000] hover:bg-[#EC3338] shadow-xl
                         transition-all duration-300 group font-inter cursor-pointer"
              data-aos="fade-up"
            >
              Learn More
              <Send
                className="w-5 h-5 text-white transform rotate-45 transition-transform group-hover:translate-x-1"
              />
            </button>
          </div>
          ...
          <div className="relative md:w-1/2 flex justify-center items-center" data-aos="fade-left">
            {/* Soft circular glow */}
            <div
              className="absolute w-96 h-96 rounded-full bg-[#EC3338]/5 blur-3xl "
      ...
      <div className="flex justify-end mt-10 pr-10" data-aos="fade-right">
        <Send
          className="w-8 h-8 rotate-45 text-[#EC3338] hover:translate-x-2 transition-transform duration-300"
        />
      </div>
    </section>
  );
