...
import shoe from "/src/assets/red-shoe.png";

// 🔥 CUSTOM BOUNCE ANIMATION (inside same file)
...
@keyframes smoothBounce {
  ...
  50% { 
    transform: translateY(-18px);   /* bounce height */
  }
}
...
if (typeof document !== "undefined") {
  ...
  styleTag.innerHTML = customAnimation;
...
const AuthorizedDistributor = () => {
  ...
  return (
    <section
      className="relative overflow-hidden py-5 md:py-1 px-6 md:px-16"
      style={{
        background: "linear-gradient(135deg, #f1f5ff 0%, #ffffff 40%, #f5ead3 100%)",
      }}
    >
      {/* Decorative Blue Glow */}
      <div className="absolute -top-10 -left-16 w-80 h-80 bg-[#2563eb]/15 blur-3xl rounded-full"></div>
