...
import fabric3 from "/src/assets/Nursery.png";
    ...
    <section className="relative w-full h-[500px] md:h-[650px] overflow-hidden">
      ...
      >
        <div className="px-6 md:px-16 max-w-3xl text-white">
          ...
          <button className="mt-6 bg-[#c9a759] text-black px-6 py-3 rounded-full font-semibold text-sm md:text-base shadow-lg">
            Explore Our Range
          </button>
        </div>
      </div>
