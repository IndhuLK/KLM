...
import jacket1 from "/src/assets/Uni4.png";
import jacket2 from "/src/assets/Uni5.png";
import jacket3 from "/src/assets/Uni6.png";;
...
const JacketsSlider = () => {
  const slides = [
    {
      image: jacket1,
      title: "Smart. Warm. School-Ready.",
      subtitle: "Discover cozy jackets made for every school day.",
    },
    {
      image: jacket2,
      title: "Comfort That Lasts All Day.",
      subtitle: "Soft, durable, and perfect for morning assemblies.",
    },
    {
      image: jacket3,
      title: "Stylish Layers for Little Scholars.",
      subtitle: "Keep your kids warm while they stay active and confident.",
    },
  ];
