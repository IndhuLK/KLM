...
import uni3 from "/src/assets/Uni1.jpg";
...
const Hero = () => {
  const slides = [
    {
      image: uni2, // 👈 replace with your background image
    ...
    <section className="relative w-full h-[500px] md:h-[650px] overflow-hidden">
      ...
      <Slider ref={sliderRef} {...settings}>
        {slides.map((slide, i) => (
          <div key={i}>
            <div
              className="relative w-full h-[500px] md:h-[650px] flex flex-col items-center justify-center text-center bg-cover bg-center"
            ...
            >
              ...
              {/* Text Content */}
              <div className="relative z-20 text-white px-6 md:px-16 max-w-4xl">
                <h1
                  className="text-3xl md:text-6xl font-extrabold mb-4 leading-tight drop-shadow-lg animate-fadeIn"
                  data-aos="fade-up"
                >
                  {slide.title}
                </h1>
                <p
                  className="text-base md:text-2xl font-light tracking-wide text-white/90 leading-relaxed animate-slideUp"
                  data-aos="fade-up"
                  data-aos-delay="200"
                >
                  {slide.subtitle}
                ...
                {/* CTA Button */}
                <button
                  className="mt-6 bg-black text-white px-6 py-3 rounded-full font-semibold text-sm md:text-base 
                  hover:bg-[#EC3338] transition-all duration-300 shadow-lg"
                >
                  Explore Our Range
                </button>
              </div>
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-white/90 animate-bounce z-30">
